...
public class RelationsParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Relations");
  ...
  { 
    RelationsParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = RelationsParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = RelationsParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(RelationsParseControllerGenerated.class);
    }
  ...
  { 
    return RelationsParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
