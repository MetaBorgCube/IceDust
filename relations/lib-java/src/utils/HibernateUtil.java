...
import webdsl.generated.functions.afterTransactionCompletion_;
...
//                    System.out.println("addToValidate: "+we.getName());
      ...
      protected static class WebDSLInterceptor extends EmptyInterceptor {
        ...
        public void afterTransactionCompletion(org.hibernate.Transaction t){
          if(t.wasCommitted()){
            afterTransactionCompletion_.afterTransactionCompletion_();
          }
        }
        
        public void beforeTransactionCompletion(org.hibernate.Transaction t){
          beforeTransactionCompletion_.beforeTransactionCompletion_();
        }
        
        public void afterTransactionBegin(org.hibernate.Transaction t){
        }
