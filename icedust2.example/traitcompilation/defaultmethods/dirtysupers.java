...
{ 
  ...
  { 
    ...
    maintainCaches();
    { 
      Integer var1 = CountTen2.getTen(twenty);
    ...
    { 
      Integer var1 = CountTen2.getThirty(twenty);
      System.out.println(var1);
    }
...
class CountTen2${
  ...
  static Collection<CountTen2> dirtyTen = new HashSet<CountTen2>();
  ...
  static Collection<CountTen2> dirtyThirty = new HashSet<CountTen2>();
...
//  }
  ...
  { 
    return this.getInternalCacheTen();
  }
  ...
  static void flagDirtyTen(CountTen2 en)
  { 
    if(en != null)
      CountTen2$.dirtyTen.add(en);
  }

  static void flagDirtyTen(Collection<CountTen2> ens)
  { 
    CountTen2$.dirtyTen.addAll(ens);
  }

  public Integer getInternalCacheTen();
  public void setInternalCacheTen(Integer i);
//  protected Integer cacheTen;

//  private static Collection<CountTen2> dirtyTen = new HashSet<CountTen2>();

  default void updateThirty_cache()
  { 
...
//  }
  ...
  default void setCacheThirty(Integer en)
  { 
    setCacheIncrementalThirty(en);
  }

  default void addCacheIncrementalThirty(Integer en)
  { 
    setCacheIncrementalThirty(en);
  }

  default void removeCacheIncrementalThirty(Integer en)
  { 
    setCacheIncrementalThirty(null);
  }

  default void setCacheIncrementalThirty(Integer en)
  { 
    this.setInternalCacheThirty(en);
  }
  ...
  default Integer getThirty()
  { 
    return getCalculatedThirty();
  }

  default Integer getCalculatedThirty()
  { 
    return getInternalCacheThirty();
  }

  default Integer calculateThirty()
  { 
  ...
  default void dirtyFlagFlowstoThirty()
  { }

  static void flagDirtyThirty(CountTen2 en)
  { 
    if(en != null)
      CountTen2$.dirtyThirty.add(en);
  }

  static void flagDirtyThirty(Collection<CountTen2> ens)
  { 
    CountTen2$.dirtyThirty.addAll(ens);
  }

  public Integer getInternalCacheThirty();
  public void setInternalCacheThirty(Integer i);
//  protected Integer cacheThirty;

//  private static Collection<CountTen2> dirtyThirty = new HashSet<CountTen2>();
}

class UseCountTen2 implements CountTen2 
{ 
  public UseCountTen2 () 
  { 
    init();
...
//
  ...
  public Integer getCalculatedTen()
  { 
    return cacheTen;
  }

  public Integer calculateTen()
  { 
    return 10;
  }
  ...
  { 
    CountTen2.super.dirtyFlagFlowstoTen();
    { 
      UseCountTen2.flagDirtyTwenty(this);
    }
  }
...
//
  ...
  public void setInternalCacheTen(Integer x){cacheTen=x;}
  protected Integer cacheTen;
//
...
//
  ...
  public void setInternalCacheThirty(Integer x){
    cacheThirty = x;
  }
  protected Integer cacheThirty;
//
