...
//  { }
  ...
  default void setName(String en)
  { 
    setIncrementalName(en);
  }

  default void addIncrementalName(String en)
  { 
    setIncrementalName(en);
  }

  default void removeIncrementalName(String en)
  { 
    setIncrementalName(null);
  }

  default void setIncrementalName(String en)
  { 
    String oldValue = this.getName();
    setInternalName(en);
    String
  ...
  default void dirtyFlagFlowstoName()
  { 
    { 
      Book var1 = Expressions.filterType(this, Book.class);
      Book.flagDirtyTitle(var1);
