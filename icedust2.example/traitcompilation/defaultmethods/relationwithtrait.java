...
//  { }
  ...
  default void addPictures(Picture en)
  { 
    Collection<Picture> newValue = Expressions.emptyCollection();
//    newValue.addAll(this.pictures);
    newValue.addAll(this.getPicturesInternal());
    newValue.add(en);
    setPictures(newValue);
  }

  default void addPictures(Collection<Picture> en)
  { 
    Collection<Picture> newValue = Expressions.emptyCollection();
//    newValue.addAll(this.pictures);
    newValue.addAll(getPicturesInternal());
    newValue.addAll(en);
    setPictures(newValue);
  }

  default void removePictures(Picture en)
  { 
    Collection<Picture> newValue = Expressions.emptyCollection();
//    newValue.addAll(this.pictures);
    newValue.addAll(this.getPicturesInternal());
  ...
  default void removePictures(Collection<Picture> en)
  { 
    Collection<Picture> newValue = Expressions.emptyCollection();
//    newValue.addAll(this.pictures);
    newValue.addAll(this.getPicturesInternal());
...
//    toRemove.addAll(pictures);
  ...
  default void addIncrementalPictures(Picture en)
  { 
    Collection<Picture> newValue = Expressions.emptyCollection();
//    newValue.addAll(this.pictures);
    newValue.addAll(this.getPicturesInternal());
  ...
  default void removeIncrementalPictures(Picture en)
  { 
    Collection<Picture> newValue = Expressions.emptyCollection();
//    newValue.addAll(this.pictures);
    newValue.addAll(this.getPicturesInternal());
  ...
  default void setIncrementalPictures(Collection<Picture> en)
  { 
//    this.pictures = en;
    this.setPicturesInternal(en);
  }
  ...
  public default Collection<Picture> getPictures()
  { 
//    return pictures;
    return this.getPicturesInternal();
  }

  default void dirtyFlagFlowstoPictures()
  { }

  public Collection<Picture> getPicturesInternal();
  public void setPicturesInternal(Collection<Picture> pictures);
  
//  protected Collection<Picture> pictures = Expressions.emptyCollection();
}

class Page implements HasPictures 
{ 
  public Page () 
  { }
