...
class CountTen2${
  ...
  public static void flagDirtyTen(UseCountTen2 en)
  { 
    if(en != null)
      dirtyTen.add(en);
  }

  public static void flagDirtyTen(Collection<UseCountTen2> ens)
  { 
    dirtyTen.addAll(ens);
  }

  public static Collection<CountTen2> dirtyTen = new HashSet<CountTen2>();
  ...
  public static void flagDirtyThirty(CountTen2 en)
  { 
    if(en != null)
      dirtyThirty.add(en);
  }

  public static void flagDirtyThirty(Collection<CountTen2> ens)
  { 
    dirtyThirty.addAll(ens);
  }
  
  public static Collection<CountTen2> dirtyThirty = new HashSet<CountTen2>();
}
...
//  private static Collection<UseCountTen2> dirtyTen = new HashSet<UseCountTen2>();
  ...
  public void updateThirty_cache()
  { 
    setCacheThirty(calculateThirty());
  }
